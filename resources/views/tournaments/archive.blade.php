                                            ...
                                            @foreach($projects as $participant)
                                                <div class="border border-amber-800/20 rounded-lg overflow-hidden shadow-sm bg-gray-800 hover:bg-gray-750 transition-colors">
                                                    <div class="p-6">
                                                        ...
                                                        <!-- Single Action Button - View Tournament Only -->
                                                        <div class="flex">
                                                            <a href="{{ route('tournaments.show', $participant->tournament) }}" 
                                                               class="inline-flex items-center px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white text-sm font-medium rounded-md transition duration-150">
