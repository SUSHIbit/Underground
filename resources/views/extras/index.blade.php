                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg border border-amber-800/20 hover:shadow-md transition-shadow duration-300">
                        <div class="p-5">
                            ...
                            <a href="{{ route('ranks.index') }}" class="inline-flex items-center px-4 py-2 bg-amber-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-amber-700 active:bg-amber-800 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition ease-in-out duration-150">
                    ...
                    <div class="bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg border border-amber-800/20 hover:shadow-md transition-shadow duration-300">
                        <div class="p-5">
                            ...
                            <a href="{{ route('skills.index') }}" class="inline-flex items-center px-4 py-2 bg-amber-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-amber-700 active:bg-amber-800 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg border border-amber-800/20 hover:shadow-md transition-shadow duration-300">
                        <div class="p-5">
                            ...
                            <a href="{{ route('leaderboard') }}" class="inline-flex items-center px-4 py-2 bg-amber-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-amber-700 active:bg-amber-800 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div class="bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg border border-amber-800/20 hover:shadow-md transition-shadow duration-300">
                        <div class="p-5">
                            ...
                            <a href="{{ route('uepoints.index') }}" class="inline-flex items-center px-4 py-2 bg-amber-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-amber-700 active:bg-amber-800 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition ease-in-out duration-150">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
